...
<body class="main-layout">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-item nav-link" href="/produk/show">Katalog</a>
                                <a class="nav-item nav-link" href="/faq">FAQ</a>
                                <!-- <a class="nav-item nav-link" href="racing boots.html">Racing Boots</a> -->
                                <a class="nav-item nav-link" href="/contact">Contact</a>
                                <a class="nav-item nav-link" href="#"><img src="images/search_icon.png"></a>
                                <a class="nav-item nav-link" href="/bag"><img src="images/shop_icon.png"></a>
                            </div>
                        </div>
                    </nav>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="banner_taital">
                                                ...
                                                <br>
                                                <h1 class="mens_text"><strong>Bazzars</strong></h1>
                                                <br>
                                                ...
                                                <a href="katalog.html"><button class="buy_bt">Buy Now</button></a>
                                                <!-- <button class="more_bt">See More</button> -->
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="shoes_img"><img src="images/home.png"></div>
                                        </div>
                                    </div>
                                </div>
						...
						<p class="mens_taital_2">Men Shoes</p> -->
                                        ...
                                        <div class="col-sm-5">
                                            <div class="banner_taital">
                                                ...
                                                <!-- <p class="lorem_text">ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p> -->
                                                <button class="buy_bt">Buy Now</button>
                                                <!-- <button class="more_bt">liat yang lain</button> -->
                                            </div>
                                        </div>
                                        <div class="col-sm-5">
                                            <div class="shoes_img"><img src="images/home.png"></div>
    ...
    <!-- <div class="layout_padding collection_section">
    	<div class="container">
    	    <h1 class="new_text"><strong>About Bazzars</strong></h1>
    	    <p class="consectetur_text">Bazaars adalah sebuah program kerja dari Kewirausahaan IMA FTUI Departemen Arsitektur Universitas Indonesia yang berperan sebagai sumber pemasukan  melalui penjualan peralatan studio sebagai bentuk pemenuhan kebutuhan warga Departemen Arsitektur.
			</p>
    ...
    <div class="collection_section">
        <div class="container">
            <br>
            <h1 class="new_text"><strong>About Bazzars</strong></h1>
            <p class="consectetur_text">Bazaars adalah sebuah program kerja dari Kewirausahaan IMA FTUI Departemen Arsitektur Universitas Indonesia yang berperan sebagai sumber pemasukan melalui penjualan peralatan studio sebagai bentuk pemenuhan kebutuhan warga Departemen Arsitektur.</p>
            <div class="col-md-8">
            ...
            <div class="mail_section">
                <div class="row">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="footer-logo"><img src="images/email-icon.png"><span class="map_text">kewirausahaanimaftui@gmail.com</span></div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="social_icon">
                            <ul>
                                <li><a href="https://www.facebook.com/teknikui89"><img src="images/fb-icon.png"></a></li>
                                <li><a href="https://twitter.com/BemFTUI"><img src="images/twitter-icon.png"></a></li>
                                <li><a href="https://www.linkedin.com/company/bem-ftui/"><img src="images/in-icon.png"></a></li>
            ...
            <div class="footer_section_2">
                <div class="row">
                    ...
                    <div class="col-sm-4 col-lg-2">
                        ...
                        <div class="image-icon"><img src="images/map-icon.png"><span class="pet_text">Departemen Arsitektur, Fakultas Teknik, Universitas Indonesia, Beji, Depok 16424</span></div>
                    </div>
    ...
    <!-- section footer end -->
    <div class="copyright">2021 All Rights Reserved. <a href="https://html.design"></a></div>
